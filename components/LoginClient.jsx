  ...
  return (
    <div className="max-w-md mx-auto py-20 px-4">
      ...
      <div className="mt-12 pt-8 border-t text-center space-y-4">
        ...
        <Link href={`/signup${redirect ? `?redirect=${redirect}` : ''}`} className="text-sm font-bold uppercase tracking-widest border-b-2 border-black pb-1 hover:text-[#A08C5B] hover:border-[#A08C5B] transition-all">
          Create Account
        </Link>
      </div>
    </div>
